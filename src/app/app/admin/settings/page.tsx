    ...
    <section className="section-panel space-y-4">
      ...
      <form action={updateSchoolAction} className="grid gap-3 md:grid-cols-2">
        ...
        <label className="space-y-1">
          ...
          <input name="code" defaultValue={school.code} className="input" required />
        </label>
        <label className="space-y-1">
          <span className="field-label">Country</span>
          <input name="country" defaultValue={school.country ?? ""} className="input" />
        </label>
        <label className="space-y-1">
          <span className="field-label">Logo URL</span>
          <input name="logoUrl" defaultValue={school.logoUrl ?? ""} className="input" placeholder="https://..." />
        </label>

        <label className="space-y-1 md:col-span-2">
          <span className="field-label">Address Line 1</span>
          <input name="addressLine1" defaultValue={school.addressLine1 ?? ""} className="input" />
        </label>
        <label className="space-y-1 md:col-span-2">
          <span className="field-label">Address Line 2</span>
          <input name="addressLine2" defaultValue={school.addressLine2 ?? ""} className="input" />
        </label>
        ...
        <label className="space-y-1">
          ...
          <input name="state" defaultValue={school.state ?? ""} className="input" />
        </label>

        <label className="space-y-1">
          <span className="field-label">Postal Code</span>
          <input name="postalCode" defaultValue={school.postalCode ?? ""} className="input" />
        </label>
        <label className="space-y-1">
        ...
        <label className="space-y-1 md:col-span-2">
          ...
          <input name="website" defaultValue={school.website ?? ""} className="input" placeholder="https://school.edu" />
        </label>
