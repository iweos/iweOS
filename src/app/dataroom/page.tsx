  ...
  return (
    <>
      <section className="platform-hero">
        ...
        <Link href="/dataroom/schools">Explore schools <ArrowUpRight /></Link>
      </section>
      ...
      <div className="platform-content-grid">
        <section className="platform-panel platform-schools-panel">
          <div className="platform-panel-heading"><div><p>Recently added</p><h2>School workspaces</h2></div><Link href="/dataroom/schools">View directory <ArrowUpRight /></Link></div>
