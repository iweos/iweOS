    ...
    (
      <div
        style={{
          ...
          background: "linear-gradient(160deg, #163022 0%, #2f6b3f 55%, #c78932 100%)",
          borderRadius: 120,
          position: "relative",
          overflow: "hidden",
        }}
      >
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: "radial-gradient(circle at 22% 20%, rgba(255,255,255,0.18), transparent 32%), radial-gradient(circle at 82% 78%, rgba(255,255,255,0.14), transparent 28%)",
          }}
        />
        <div
          style={{
        ...
        >
          <svg width="320" height="320" viewBox="0 -64 512 512" fill="#ffffff">
