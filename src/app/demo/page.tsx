...
export const metadata: Metadata = {
  title: "Request Demo",
  description: "Request a demo of iweOS for school grading and SchoolPayApp.",
};
  ...
  return (
    <main className="container py-16">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <Link href="mailto:support@iweos" className="rounded-md bg-[#0f766e] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#0d5f59]">
          Email support@iweos
        </Link>
